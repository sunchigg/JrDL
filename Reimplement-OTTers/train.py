"""
(4.71 4.46 4.65)(in_domain) python train.py
(5.16 4.53 5.36) python train.py --domain out_of_domain --output_dir runs/finetune_out
"""
import json
import csv
import os
...
def parse_args():
    ...
    parser.add_argument(
        "--max_epoch", default=30, type=int, help="total number of epoch"
    )  # 10
    parser.add_argument(
        "--train_bsize", default=128, type=int, help="training batch size"
    )  # 16
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    output_prediction_file = \
        os.path.join(training_args.output_dir, "generated_predictions.txt")
