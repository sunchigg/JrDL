"""
[T5]
(34.989) python perplexity.py out_t5_in.txt
(33.378) python perplexity.py out_t5_out.txt
[GPT2]
(44.353) python perplexity.py out_gpt2_in.txt
(41.634) python perplexity.py out_gpt2_out.txt
"""
