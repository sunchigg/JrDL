...
def parse_args() -> Namespace:
    ...
    parser.add_argument(
        "--model_name",
        type=str,
        default="saved/0509-0059_12ep_5e-5_512",  # 再換
        )  # From google/mt5-small
    parser.add_argument("--train_batch_size", type=int, default=4)  # 16 OOM
    parser.add_argument("--valid_batch_size", type=int, default=16)  # 64
    parser.add_argument("--lr", type=float, default=4e-5)
    parser.add_argument("--weight_decay", type=float, default=1e-2)
    parser.add_argument("--epoch_num", type=int, default=2)  # 1, 2
    ...
    parser.add_argument("--rl_ratio", type=float, default=1)  # 0
    parser.add_argument("--rl_top_k", type=float, default=0)  # 0
    parser.add_argument("--rl_top_p", type=float, default=0.2)  # 0.2
    parser.add_argument("--rl_temperature", type=float, default=0.5)  #
    parser.add_argument("--log_steps", type=int, default=250)  # 250
